...
container_definitions = jsonencode([{
    ...
    environment = [
      ...
      {
        name  = "API_PORT"
        value = "3000"  # Port da API Node
      },
      {
        name  = "DB_DATABASE"
        value = local.db_name  # Defina conforme sua variável ou local
      },
      {
        name  = "DB_HOST"
        value = local.db_host  # Defina conforme sua variável ou local
      },
      {
        name  = "DB_PORT"
        value = "5432"  # Port do banco de dados
      },
      {
        name  = "DB_USER"
        value = local.db_user  # Defina conforme sua variável ou local
      },
      {
        name  = "DB_PASSWORD"
